...
% Last Modified by GUIDE v2.0 26-Apr-2005 15:03:09
...
disp('Murat Aytekin maytekin@umd.edu');
...
D3_GLOBAL.trial_params.fvideo = 240 ;
D3_GLOBAL.trial_params.clip(1).start = 0 ; %video clip 1 starts at....
D3_GLOBAL.trial_params.clip(2).start = 0 ;
D3_GLOBAL.trial_params.trial_start = 0 ;
D3_GLOBAL.trial_params.trial_end = 1 ;
...
startframe = round(tstart * 240) + 1920 ; %not the start of the data but the start of the video data, according to the db
...
set(D3_GLOBAL.handles.clip_start_c1_frame_edit,'string',num2str(D3_GLOBAL.trial_params.clip(1).start * 240));
set(D3_GLOBAL.handles.clip_start_c2_frame_edit,'string',num2str(D3_GLOBAL.trial_params.clip(2).start * 240));
set(D3_GLOBAL.handles.trial_start_frame_edit,'string',num2str(D3_GLOBAL.trial_params.trial_start * 240));
set(D3_GLOBAL.handles.trial_end_frame_edit,'string',num2str(D3_GLOBAL.trial_params.trial_end * 240));
set(D3_GLOBAL.handles.trialcode_edit,'string',D3_GLOBAL.tcode);

startframe =  round(D3_GLOBAL.trial_params.trial_start * 240) + 1920;
endframe =  round(D3_GLOBAL.trial_params.trial_end * 240) + 1920;
...
case 1 %calibration
    try
        axes(handles.axes1);
        imagesc(D3_GLOBAL.calibration.image(D3_GLOBAL.camera).c.cdata);hold on;
...
frame_cam_speedadj = frame_cam .* speed_factor ;
...
% --------------------------------------------------------------------
% This is only called when we first load a trial. If we don't have a video file we set stuff from the analysed data
...
D3_GLOBAL.trial_params.trial_start = str2num(get(gcbo,'string')) / 240  ;
set(handles.trial_start_edit,'string',num2str(D3_GLOBAL.trial_params.trial_start));
D3_GLOBAL.d3_analysed.startframe =  round(D3_GLOBAL.trial_params.trial_start * 240) + 1920;
...
D3_GLOBAL.trial_params.trial_end = str2num(get(gcbo,'string')) / 240 ;
set(handles.trial_end_edit,'string',num2str(D3_GLOBAL.trial_params.trial_end));
D3_GLOBAL.d3_analysed.endframe =  round(D3_GLOBAL.trial_params.trial_end * 240) + 1920;
set(handles.db_frame_text,'string',[ num2str(D3_GLOBAL.d3_analysed.startframe) ' , ' num2str(D3_GLOBAL.d3_analysed.endframe)]);
load_trial_video(handles,1)
load_trial_video(handles,2)
update(handles);
...
D3_GLOBAL.trial_params.clip(1).start = str2num(get(gcbo,'string')) / 240  ; %video clip 1 starts at....
...
set(handles.trial_start_frame_edit,'string',num2str(round(D3_GLOBAL.trial_params.clip(1).start*240)));%this means that we'll get all of the clip #1
set(handles.clip_start_c2_frame_edit,'string',num2str(round(D3_GLOBAL.trial_params.clip(1).start*240)));%this means that we'll get all of the clip #2
...
D3_GLOBAL.trial_params.clip(2).start = str2num(get(gcbo,'string')) /240 ;
...
if D3_GLOBAL.trial_params.clip(2).start > existingtrialstartval
    ...
    set(handles.trial_start_frame_edit,'string',num2str(round(D3_GLOBAL.trial_params.clip(2).start*240)));%this means that we'll get all of the clip #1
end
D3_GLOBAL.trial_params.trial_start = str2num(get(handles.trial_start_edit,'string')) ;
...
set(handles.clip_start_c1_frame_edit,'string',num2str(round(D3_GLOBAL.trial_params.clip(1).start * 240)));
...
set(handles.trial_start_frame_edit,'string',num2str(round(D3_GLOBAL.trial_params.trial_start * 240)));
set(handles.clip_start_c2_frame_edit,'string',num2str(round(D3_GLOBAL.trial_params.clip(2).start * 240)));
...
if D3_GLOBAL.trial_params.clip(2).start > existingtrialstartval
    set(handles.trial_start_edit,'string',num2str(D3_GLOBAL.trial_params.clip(2).start));%this means that we'll get all of the clip #2
    set(handles.trial_start_frame_edit,'string',num2str(round(D3_GLOBAL.trial_params.clip(2).start * 240)));
end
D3_GLOBAL.trial_params.trial_start = str2num(get(handles.trial_start_edit,'string')) ;
D3_GLOBAL.d3_analysed.startframe =  round(D3_GLOBAL.trial_params.trial_start * 240) + 1920;
D3_GLOBAL.d3_analysed.endframe =  round(D3_GLOBAL.trial_params.trial_end * 240) + 1920;
...
set(handles.trial_end_frame_edit,'string',num2str(round(D3_GLOBAL.trial_params.trial_end * 240)));
set(handles.db_frame_text,'string',[ num2str(D3_GLOBAL.d3_analysed.startframe) ' , ' num2str(D3_GLOBAL.d3_analysed.endframe)]);
load_trial_video(handles,1)
load_trial_video(handles,2)
update(handles);
...
save([mat_file_path '/' tcode '_' num2str(startframe) '_d3.mat' ],'d3_analysed'); 
